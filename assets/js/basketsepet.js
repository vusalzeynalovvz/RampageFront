...
let closeBtnClick = document.getElementById("ikis-buttonu");
...
// ALL BASKET DELIVERY START
// const shopping_Information = document.getElementById("shopping");
// const shopping_left = document.getElementById("shopping-left");
// const delivery_Information = document.getElementById("delivery-Information");
// const delivery_Left = document.getElementById("delivery-left");
// const payment_Information = document.getElementById("payment-Information");
// const payment_Left = document.getElementById("payment-left");
// shopping_Information.addEventListener("click", () => {
//   shopping_left.style.display = "block";
//   delivery_Left.style.display = "none";
//   payment_Left.style.display = "none";
// });
// delivery_Information.addEventListener("click", () => {
//   shopping_left.style.display = "none";
//   delivery_Left.style.display = "block";
//   payment_Left.style.display = "none";
// });
// payment_Information.addEventListener("click", () => {
//   shopping_left.style.display = "none";
//   delivery_Left.style.display = "none";
//   payment_Left.style.display = "block";
// });
// ALL BASKET DELIVERY End
